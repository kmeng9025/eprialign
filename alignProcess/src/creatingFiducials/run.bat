...
python -c "import torch, torchvision, numpy, scipy, matplotlib, sklearn, h5py, tqdm" 2>nul
if %errorlevel% neq 0 (
    echo.
...
echo   • Automatically checks for required Python packages and offers installation
echo.
@REM pause
exit /b 0
